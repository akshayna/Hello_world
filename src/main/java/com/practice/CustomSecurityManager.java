...
public class CustomSecurityManager {
	...
	public CustomSecurityManager() {
		synchronized (CustomSecurityManager.class) {
	...
	private static CustomThreadGroup rootGroup = getRootGroup();

	private static CustomThreadGroup getRootGroup() {
		CustomThreadGroup root = CustomThread.currentThread().getThreadGroup();
	 ...
	 * @see #checkPermission(java.security.Permission) checkPermission
	 */
	public void checkAccess(CustomThread t) {
		if (t == null) {
	 ...
	 * @see #checkPermission(java.security.Permission) checkPermission
	 */
	public void checkAccess(CustomThreadGroup g) {
		if (g == null) {
	 ...
	 * number.
	 * <p>
	 * If port is not 0, this method calls <code>checkPermission</code> with the
	 * <code>SocketPermission("localhost:"+port,"listen")</code>. If port is
	 * zero, this method calls <code>checkPermission</code> with
	 * <code>SocketPermission("localhost:1024-","listen").</code>
	 * <p>
	 * If you override this method, then you should make a call to
	 ...
	 * <p>
	 * This method calls <code>checkPermission</code> with the
	 * <code>AWTPermission("accessClipboard")</code> permission.
	 * <p>
	 * If you override this method, then you should make a call to
